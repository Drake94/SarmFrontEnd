...
const Pagination = ({samplesForPage, totalSamples, currentPage, setCurrentPage}) => {
...
if(pageNumbers.length > maxPageNumbersLimit){
    pageIncrementBtn = <li onClick={onNextPage}><span class="pagination-ellipsis">&hellip;</span></li>
}

let pageDecrementBtn = null;
if(pageNumbers.length > maxPageNumbersLimit){
    pageDecrementBtn = <li onClick={onPreviousPage}><span class="pagination-ellipsis">&hellip;</span></li>
}
...
const renderPageNumbers = pageNumbers.map(noPage => {
    ...
    return (
        <nav 
            className="pagination mt-5 is-centered" role="navigation" aria-label="pagination">
